                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="date" class="form-control" name="training_tanggal" value="{{ $room_data->training_tanggal }}">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Jenis Training *</label>
                                    <div>
                                        <select class="form-select" name="jenis_training">
                                            <option value="Internal"{{ $room_data->jenis_training == 'Internal' ? ' selected' : '' }}>Internal</option>
                                            <option value="External"{{ $room_data->jenis_training == 'External' ? ' selected' : '' }}>External</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="mb-4">
