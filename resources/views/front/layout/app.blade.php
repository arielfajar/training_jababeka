...
<html lang="en">
    <head>
        ...
        <title>Jababeka Learning Website</title>        
                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto">        
                                ...
                                <li class="nav-item">
                                    <a href="javascript:void;" class="nav-link dropdown-toggle">Training Catalog</a>
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                            <a href="{{ route('filter_by_type', ['jenis_training' => 'Internal']) }}" class="nav-link">Internal</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="{{ route('filter_by_type', ['jenis_training' => 'External']) }}" class="nav-link">External</a>
                                        </li>
                                    </ul>
                                </li>
                    ...
                    <div class="col-md-3">
                        <div class="item">
                            ...
                            <ul class="social">
                                ...
                                <li><a href="{{ $global_setting_data->pinterest }}"><i class="fa fa-instagram"></i></a></li>
                                @endif
