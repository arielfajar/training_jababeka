                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <td>{{ $single_room_data->training_tanggal }}</td>
                            </tr>
                            <tr>
                                <th>Durasi</th>
                            ...
                            <tr>
                                ...
                                <td>{{ $single_room_data->jenis_training }}</td>
                            </tr>
                            <tr>
                ...
                <div class="sidebar-container" id="sticky_sidebar">
                    ...
                    <div class="widget">
                        ...
                        <form action="{{ route('registration.form') }}" method="get">
                            ...
                            <button type="submit" class="book-now">Daftar Training Ini</button>
                        </form>
                    </div>
