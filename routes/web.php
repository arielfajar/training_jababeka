...
Route::get('/filter-room', [RoomController::class, 'filterByType'])->name('filter_by_type');
Route::get('/rooms/filter', [RoomController::class, 'filter'])->name('filter_rooms');
...
Route::get('/daftar', [UserRegistrationController::class, 'showRegistrationForm'])->name('registration.form');
Route::post('/registration/submit', [UserRegistrationController::class, 'submit'])->name('registration.submit');
